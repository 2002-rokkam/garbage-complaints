// authority/SMD/SMDD2D/SMDD2DCalnderActivity.dart
...
class SMDD2DCalnderActivityScreen extends StatefulWidget {
  final String section;
  final String district;
  final String block;
  final String gramPanchayat;

  const SMDD2DCalnderActivityScreen({
    Key? key,
  ...
  @override
  _SMDD2DCalnderActivityScreenState createState() =>
      _SMDD2DCalnderActivityScreenState();
}

class _SMDD2DCalnderActivityScreenState
    extends State<SMDD2DCalnderActivityScreen>
