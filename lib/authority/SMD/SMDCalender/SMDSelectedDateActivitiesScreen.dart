// authority/SMD/SMDCalender/SMDSelectedDateActivitiesScreen.dart
import 'package:flutter/material.dart';

// authority/SelectedDateActivitiesScreen.dart
class SMDSelectedDateActivitiesScreen extends StatelessWidget {
  final DateTime selectedDate;
  final List activities;

  const SMDSelectedDateActivitiesScreen({
    Key? key,
