  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: _tabController.index == 0
          ...
          : null, // Removes the button for "Trip Details"
    );
  }
}
...
class TripDetailCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double cardWidth = screenWidth * 0.85; // 85% of the screen width
    double cardHeight = screenHeight * 0.75; // 75% of the screen height
    double containerWidth = screenWidth * 0.85; // 85% of the screen width
    double textFieldHeight = 56.0; // Fixed height for text fields
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            // First Container: 'Trips' title and text field
            ...
            SizedBox(height: 16),
            // Second Container: 'Quantity of Waste'
            _buildDetailContainer(
            ...
            SizedBox(height: 16),
            // Third Container: 'Segregated Degradable Waste'
            _buildDetailContainer(
            ...
            SizedBox(height: 16),
            // Fourth Container: 'Segregated Non-Degradable Waste'
            _buildDetailContainer(
            ...
            SizedBox(height: 16),
            // Fifth Container: 'Segregated Plastic Waste'
            _buildDetailContainer(
            ...
            _buildSubmitButton(containerWidth),
          ],
        ),
      ),
    );
  ...
  // Helper widget for the detail containers
  Widget _buildDetailContainer({
    ...
    return Container(
      ...
      height: textFieldHeight + 40, // Add some margin for the title
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(
  ...
  // Helper widget to build the TextField
  ...
  // Helper widget for the Submit button container
