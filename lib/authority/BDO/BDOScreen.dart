  ...
  Widget _getPage(String routeName) {
    switch (routeName) {
      case 'DoorToDoorScreen':
        return BDOD2DCalnderActivityScreen(section: 'Door to Door');
      case 'RoadSweepingScreen':
        return BDOCalendarActivityScreen(section: 'Road Sweeping');
      case 'DrainCleaningScreen':
        return BDOCalendarActivityScreen(section: 'Drainage Cleaning');
      case 'CSCScreen':
        return BDOCalendarActivityScreen(section: 'CSC');
      case 'RRCScreen':
        return BDORCCCalendarActivityScreen(section: 'RRC');
      case 'WagesScreen':
        return BDOWagesCalendarActivityScreen(section: 'Wages');
