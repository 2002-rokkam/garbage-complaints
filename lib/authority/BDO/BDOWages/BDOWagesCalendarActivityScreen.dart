...
class BDOWagesCalendarActivityScreen extends StatefulWidget {
  ...
  @override
  _BDOWagesCalendarActivityScreenState createState() =>
      _BDOWagesCalendarActivityScreenState();
}

class _BDOWagesCalendarActivityScreenState
  ...
  Future<void> fetchActivitiesForMonth(int month, int year) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          _activities = data['section_data'][widget.section]?.where((activity) {
